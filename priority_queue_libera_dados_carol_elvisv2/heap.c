...
void imprime_heap(heap_t *h,int tam)
{
    ...
    for (i = 0; i < tam; i++)
    {
        ...
        if (temp->prioridade <= 10)
        {
            printf("Lista de pacientes urgentes: Nome:%s ; Idade: %d\n", temp->nome,temp->prioridade);
        }



        if (temp->prioridade > 10 && temp->prioridade <=30)
        {
            //printf("\n----------------------------------------------");
            printf("Lista de espera 1: Nome:%s ; Idade: %d\n", temp->nome,temp->prioridade);
        }



        if (temp->prioridade > 30 && temp->prioridade <=100)
        {
            printf("Lista de espera 2: Nome:%s ; Idade: %d\n", temp->nome,temp->prioridade);
        }
